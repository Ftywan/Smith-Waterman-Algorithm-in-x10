...
public class SmithWatermanParallalTaskDAG {
    ...
    //Parameters, indicate the size of each block. Need to be n in this case. 
    private val NUM_COLS_IN_BLOCK:Int = 1n; // do not change
    private val NUM_ROWS_IN_BLOCK:Int = 1n; // do not change
